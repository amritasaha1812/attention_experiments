...
def run_training(param):
	...
	with tf.Graph().as_default():
		...
		model = TypeAttention(param['max_len'], param['max_len_mention'], param['max_len_labels'], param['hidden_size'], param['num_type_dim'], param['num_word_dim'], param['num_mention_dim'], param['num_types'], param['num_words'], param['num_mention_words'], param['learning_rate'], param['batch_size'],param['max_gradient_norm'], attention_type, param['output_activation'],descs)
