...
def get_data_dict(param):
	...
	preparedata = PrepareDataWiki(max_len, max_len_mention, max_len_labels, start_symbol_index, end_symbol_index, unk_symbol_index, pad_symbol_index, cutoff)
	preparedata.build_all_vocabs(ent_vocab_file, ent_vocab_stats_file, type_vocab_file, type_vocab_stats_file, types_file, types_hierarchy_file, train_file, valid_file, test_file)
