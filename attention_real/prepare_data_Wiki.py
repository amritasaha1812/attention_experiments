...
class PrepareDataWiki:	
	...
	def __init__(self, max_len, max_len_mention, max_len_labels, start_symbol_index, end_symbol_index, unk_symbol_index, pad_symbol_index, cutoff=-1):
	...
	def build_all_vocabs(self, ent_vocab_file, ent_vocab_stats_file, type_vocab_file, type_vocab_stats_file, types_file, type_hierarchy_file, train_file, valid_file, test_file):
		...
		if not os.path.exists(os.path.dirname(self.type_vocab_stats_file)):
			os.makedirs(os.path.dirname(self.type_vocab_stats_file))
